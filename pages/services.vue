                    ...
                    <div class="uk-flex cardt">
                        ...
                        <div class="uk-card-body cardt1-b cardl">
                            ...
                            <button class="uk-align-center" style="border-radius: 50%; padding: 8px; background-color: #191949; border: none;">
                                <img src="~assets/services/panah.svg" uk-img>
                            </button>
                        </div>
                        </div>
                        <div class="uk-margin-small-left uk-card cardt1" style="background: linear-gradient(180deg, rgba(15, 15,62, 0.02) 0%, rgba(15, 15, 62, 0.4383) 100%); box-shadow: 0px 1px 45px rgba(0, 0, 0, 0.17); border-radius: 8px; z-index: -2; width: 250px; height: 350px;">
